...
const Stories = () => {
  ...
  const categories = ['all', 'Adventure', 'Culture', 'Tips', 'Photography', 'Food'];
  ...
  const trendingStories = mockStories.slice(1, 4);
                  ...
                  <div className="max-w-3xl">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        />
                        <div>
                          <p className="text-white font-semibold">{featuredStory.author}</p>
